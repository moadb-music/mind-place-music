...
// ============================================================================
// - db: Mind Place Music - dados gerais + State of Mind
// - moadbDb: site-mindofadeadbody - discografia e dados do projeto MOADB
// - auth: Firebase Auth do projeto principal (admin panel)
// - storage: Firebase Storage do projeto principal (capas dos releases)
// ============================================================================
...
const moadbApp = initializeApp(moadbConfig, 'moadb');

export const db = getFirestore(app);
export const moadbDb = getFirestore(moadbApp);
